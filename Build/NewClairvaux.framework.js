...
// end include: preamble.js
  ...
  function _JSLibStartCompass() {
          console.log("JS Start Compass called");
  
          // Prevent multiple listeners
          if (window._compassStarted) {
              console.log("Compass already started");
              return;
          }
          window._compassStarted = true;
  
          window.addEventListener("deviceorientation", function (event) {
              console.log("orientation event firing");
              ...
              console.log("Sending heading:", heading);
  
              // IMPORTANT: Change this to your GameObject name
              SendMessage("CompassManager", "UpdateHeading", heading.toString());
          });
      }
