...
// end include: preamble.js
  ...
  function _JSLibStartCompass() {
          ...
          function startListening() {
              ...
              function handleOrientation(event) {
                  ...
                  if (typeof unityInstance !== "undefined") {
                      unityInstance.SendMessage("CompassReceiver", "UpdateHeading", heading.toString());
                  }
              }
          ...
          window.addEventListener("click", handleFirstTouch, true);
          window.addEventListener("touchend", handleFirstTouch, true);
      }
