...
// end include: preamble.js
  ...
  function _JSLibRequestCamPerms() {
          navigator.mediaDevices.getUserMedia({
              video: {
                  facingMode: { exact: "environment" },
              },
          }).then(function (stream) {
              // If successful, report that camera permissions were granted to console.
              console.log("Got Camera Permissions: ", stream);
          }).catch(function (err) {
              // Otherwise, log denial to console.
